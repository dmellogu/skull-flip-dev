export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('bigOneTile', 'assets/img/bigOneTile.png')
    this.load.image('bigTwoTile', 'assets/img/bigTwoTile.png')
    this.load.image('bigThreeTile', 'assets/img/bigThreeTile.png')
    ...
    this.load.html('gameOver', 'assets/text/gameOver.html');
    this.load.html('levelCleared', 'assets/text/levelCleared.html');
    this.load.html('mainMenu', 'assets/text/mainMenu.html');
  }
